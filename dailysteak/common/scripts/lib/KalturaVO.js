...
/**
 * @param	type	string		The type of the access control condition context
 *		 .
 */
function KalturaAccessControlContextTypeHolder(){
	this.type = null;
}
KalturaAccessControlContextTypeHolder.inheritsFrom (KalturaObjectBase);
 ...
 *		 .
 * @param	categories	string		Categories with no entitlement that this entry belong to. This field is deprecated - use CategoryEntry service.
 *		 .
 * @param	categoriesIds	string		Categories Ids of categories no entitlement that this entry belong to
 *		 .
...
KalturaReportListResponse.inheritsFrom (KalturaObjectBase);
...
KalturaUiConfAdminListResponse.inheritsFrom (KalturaObjectBase);
...
KalturaUserLoginDataListResponse.inheritsFrom (KalturaObjectBase);
...
KalturaAccessControlBlockAction.inheritsFrom (KalturaAccessControlAction);
...
KalturaAccessControlPreviewAction.inheritsFrom (KalturaAccessControlAction);
 ...
 *		  (readOnly).
 * @param	fileName	string		Name of the bulk upload file
 *		 .
...
KalturaCategoryEntryAdvancedFilter.inheritsFrom (KalturaSearchOperator);
 ...
 *		 .
 * @param	to	array		Email recipient emails and names, key is mail address and value is the name
 *		 .
 * @param	cc	array		Email cc emails and names, key is mail address and value is the name
 *		 .
 * @param	bcc	array		Email bcc emails and names, key is mail address and value is the name
 *		 .
 * @param	replyTo	array		Email addresses that a replies should be sent to, key is mail address and value is the name
 *		 .
...
KalturaIndexAdvancedFilter.inheritsFrom (KalturaSearchOperator);
 ...
 * @param	lastWorkerRemoteEqual	int		.
